...
const CustDetail = require('../models/user');
const FType=require('../models/user')
...
custDetail.create = async function (req, res, next) {
    try {
        ...
        const {firstname,lastname,email,mobile,pass} = req.body;
        var query = {firstname,lastname,email,mobile,pass};
